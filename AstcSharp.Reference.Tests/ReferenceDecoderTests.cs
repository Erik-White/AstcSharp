...
public class ReferenceDecoderTests
{
    ...
    [InlineData("checkered-5")]
    [InlineData("checkered-6")]
    [InlineData("checkered-7")]
    [InlineData("checkered-8")]
    [InlineData("checkered-9")]
    [InlineData("checkered-10")]
    [InlineData("checkered-11")]
    [InlineData("checkered-12")]
    [InlineData("footprint-4x4")]
    [InlineData("footprint-5x4")]
    [InlineData("footprint-5x5")]
    [InlineData("footprint-6x5")]
    [InlineData("footprint-6x6")]
    [InlineData("footprint-8x5")]
    [InlineData("footprint-8x6")]
    [InlineData("footprint-8x8")]
    [InlineData("footprint-10x5")]
    [InlineData("footprint-10x6")]
    [InlineData("footprint-10x8")]
    [InlineData("footprint-10x10")]
    [InlineData("footprint-12x10")]
    [InlineData("footprint-12x12")]
    [InlineData("rgb-4x4")]
    [InlineData("rgb-5x4")]
    [InlineData("rgb-6x6")]
    [InlineData("rgb-8x8")]
