...
namespace AstcSharp.Tests
{
    public class LogicalAstcBlockTests
    {
        ...
        public void ImageWithFootprint_Synthetic(string image_name, bool has_alpha, Footprint fp, int width, int height)
        {
            ...
            var our_decoded_image = new ImageBuffer();
            our_decoded_image.Allocate(width, height, has_alpha ? 4 : 3);
            ...
            var decoded_image = has_alpha ? FileBasedHelpers.LoadGoldenImageWithAlpha(image_name) : FileBasedHelpers.LoadGoldenImage(image_name);
