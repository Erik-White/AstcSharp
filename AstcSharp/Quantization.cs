// Port of astc-codec/src/decoder/quantization.{h,cc}
using System;
...
namespace AstcSharp
{
    internal static class Quantization
    {
        ...
        // Unquantization functions (ported from C++)
        ...
        private class TritQuantizationMap : QuantizationMap
        {
            ...
            {
                if ((range + 1) % 3 != 0) throw new ArgumentException(nameof(range));
        ...
        private class QuintQuantizationMap : QuantizationMap
        {
            ...
            {
                if ((range + 1) % 5 != 0) throw new ArgumentException(nameof(range));
        ...
        private class BitQuantizationMap : QuantizationMap
        {
            ...
            public BitQuantizationMap(int range, int totalUnquantizedBits)
            {
                ...
                if (CountOnes(range + 1) != 1) throw new ArgumentException(nameof(range));
        ...
        {
            if (range_max_value < kEndpointRangeMinValue || range_max_value > 255) throw new ArgumentOutOfRangeException(nameof(range_max_value));
        ...
        {
            if (range_max_value < kEndpointRangeMinValue || range_max_value > 255) throw new ArgumentOutOfRangeException(nameof(range_max_value));
            if (value < 0 || value > range_max_value) throw new ArgumentOutOfRangeException(nameof(value));
            var map = GetQuantMapForValueRange(range_max_value);
        ...
        {
            if (range_max_value < 1 || range_max_value > kWeightRangeMaxValue) throw new ArgumentOutOfRangeException(nameof(range_max_value));
        ...
        {
            if (range_max_value < 1 || range_max_value > kWeightRangeMaxValue) throw new ArgumentOutOfRangeException(nameof(range_max_value));
            if (weight < 0 || weight > range_max_value) throw new ArgumentOutOfRangeException(nameof(weight));
            var map = GetQuantMapForWeightRange(range_max_value);
