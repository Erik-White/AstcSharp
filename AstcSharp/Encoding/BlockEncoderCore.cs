...
/// </remarks>
internal static class BlockEncoderCore
{
    ...
    /// </summary>
    private static void SelectSeedFinalists<TTexel, TStrategy>(
        ReadOnlySpan<TTexel> texels, Footprint footprint, int partitionCount, ref FinalistSelector finalists)
        where TTexel : unmanaged
        where TStrategy : struct, IColorSpaceStrategy<TTexel>
    {
